...
import 'exit_confirmation_model.dart';
export 'exit_confirmation_model.dart';

class ExitConfirmationWidget extends StatefulWidget {
  const ExitConfirmationWidget({super.key});
...
class _ExitConfirmationWidgetState extends State<ExitConfirmationWidget>
  ...
  late ExitConfirmationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExitConfirmationModel());
